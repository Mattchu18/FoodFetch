...
Revision ID: 566f542da3d7
Revises: 
Create Date: 2023-07-18 12:57:11.581236
...
def upgrade():
    ...
    sa.Column('header_image', sa.String(length=1000), nullable=False),
    ...
    sa.Column('dish_image', sa.String(length=1000), nullable=False),
